...
1. **Para Copiar (Copy & Paste):**
   ...
   - No canto superior direito, clique no ícone de **dois quadradinhos** (Copy raw content).
   - O código será copiado para sua área de transferência.

2. **Para Baixar o arquivo individual:**
   - Ao lado do ícone de copiar, clique na **setinha para baixo** (Download raw file) para salvar o arquivo no seu PC.
...
3. Cole o código e clique no botão verde **"Commit changes"** no final da página.
...
2. No canto superior direito do arquivo, clique no ícone de **três pontinhos (...)**.
3. Selecione a opção **"Delete file"** (ícone da lixeira).
4. No final da página, clique no botão vermelho **"Commit changes"** para confirmar.
   - *Nota: Respeite o espaço alheio e apague apenas os seus próprios arquivos.*
